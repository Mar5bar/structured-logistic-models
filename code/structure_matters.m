...
xlabel("$t$")
ylabel("$u$")
text(1.8,11, "$\mu$", "interpreter","latex", "FontSize", 24)
...
exportgraphics(fh, "structure_matters.eps", "ContentType", "vector")
exportgraphics(fh, "structure_matters.pdf", "ContentType", "vector")